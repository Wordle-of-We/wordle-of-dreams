      ...
      <div className="flex items-center justify-between max-w-5xl mx-auto">
        ...
        <div className="flex items-center space-x-2 sm:space-x-6">
          ...
          >
            ...
            <div
              className={`absolute right-0 mt-2 w-44 bg-white border border-gray-200 rounded-lg shadow-lg overflow-hidden transition-all duration-150 ${openModes
          ...
          >
            <div
              className={`absolute right-0 mt-2 w-48 bg-white border border-gray-200 rounded-lg shadow-lg overflow-hidden transition-all duration-150 ${openUser
                  ? 'opacity-100 translate-y-0 pointer-events-auto'
                  : 'opacity-0 -translate-y-1 pointer-events-none'
                }`}
              role="menu"
